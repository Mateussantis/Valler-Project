...
namespace backend.Controllers
{
    ...
    public class FIltroTrueController
    {
        ...
        //                 Categoria1 = c.IdCategoriaNavigation.Categoria1
        //             },
        ...
        //         }
        //     ).Where(c => c.IdCategoriaNavigation.Categoria1 == filtromodel.filtro).ToListAsync();
        ...
        public async Task<List<Oferta>> listafiltro(FiltroModel filtromodel)
        {
            ...
            ).Where(o => o.IdProdutoNavigation.IdCategoriaNavigation.Categoria1 == filtromodel.filtro).ToListAsync();
